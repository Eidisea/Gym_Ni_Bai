...
<head>
    ...
    <title>Member Registration — {{ config('app.name') }}</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center py-10">
    <div class="w-full max-w-lg bg-white rounded-2xl shadow-md p-8">
        ...
        <div class="text-center mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Create Your Member Account</h1>
            <p class="text-sm text-gray-500 mt-1">Join the gym and start your fitness journey.</p>
        </div>
        ...
        <form method="POST" action="{{ route('customer.register.post') }}" novalidate>
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button" class="eye-toggle" data-target="password" aria-label="Toggle password visibility">
                        ...
                        <svg class="icon-eye-slash hidden" xmlns="http://www.w3.org/2000/svg" fill="none"
                             viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                  d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.512 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88"/>
                        </svg>
                    </button>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button" class="eye-toggle" data-target="password_confirmation" aria-label="Toggle confirm password visibility">
                        <svg class="icon-eye-open" xmlns="http://www.w3.org/2000/svg" fill="none"
                             viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                  d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z"/>
            ...
            <p class="text-center text-sm text-gray-500 mt-4">
                ...
                <a href="{{ route('customer.login') }}" class="text-indigo-600 hover:underline font-medium">Sign in here</a>
            </p>
        </form>
    </div>
