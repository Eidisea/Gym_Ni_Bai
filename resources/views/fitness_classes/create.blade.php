...
@section('title', 'Create Fitness Class')
@section('subtitle', 'Add a new fitness class type')
    ...
    <ol class="inline-flex items-center space-x-1">
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('management.fitness-classes.index') }}" class="text-gray-400 hover:text-gray-100 text-sm transition-colors">
                    Fitness Classes
                </a>
            </div>
        </li>
...
<div class="mb-4">
    <h1 class="text-lg font-bold text-gray-100">Create Fitness Class</h1>
    <p class="text-xs text-gray-400 mt-0.5">Add a new fitness class type</p>
</div>

<div class="bg-slate-800 border border-slate-700 rounded-lg p-4">
    <form method="POST" action="{{ route('management.fitness-classes.store') }}">
        @csrf
