...
<div class="bg-slate-800 border border-slate-700 rounded-lg p-4">
    <form method="POST" action="{{ route('management.payment-transactions.update', $paymentTransaction) }}">
        @csrf
        @method('PUT')
        ...
        <div class="flex items-center justify-end space-x-3 mt-6 pt-4 border-t border-slate-700">
            <a href="{{ route('management.payment-transactions.show', $paymentTransaction) }}" 
