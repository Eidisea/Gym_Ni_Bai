...
@section('subtitle', 'Create a new class schedule')
    ...
    <ol class="inline-flex items-center space-x-1">
        ...
        <li>
            <div class="flex items-center">
                ...
                <span class="text-gray-100 text-sm font-medium">Schedule Class</span>
            </div>
        </li>
    </ol>
</nav>
...
<div class="mb-4">
    <h1 class="text-xl font-bold text-gray-100">Schedule Class</h1>
</div>

<div class="bg-slate-800 border border-slate-700 rounded-lg p-4">
    <form method="POST" action="{{ route('management.class-schedules.store') }}">
        @csrf
            ...
            <div>
                ...
                <select name="trainer_id" id="trainer_id"
                    ...
                    @foreach($trainers as $trainer)
                        <option value="{{ $trainer->trainer_id }}" {{ old('trainer_id') == $trainer->trainer_id ? 'selected' : '' }}>
