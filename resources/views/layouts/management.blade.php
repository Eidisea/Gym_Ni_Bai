            ...
            <nav class="flex-1 px-4 py-4 space-y-1">
                ...
                <div class="space-y-0.5">
                    ...
                    <a href="{{ route('payment-transactions.index') }}" 
                       class="flex items-center px-2 py-1.5 text-sm font-medium rounded-lg transition-colors
                              {{ request()->routeIs('payment-transactions.*') && !request()->routeIs('payment-transactions.cash-process') ? 'bg-indigo-600 text-white' : 'text-gray-300 hover:bg-slate-700 hover:text-white' }}">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('payment-transactions.cash-process') }}" 
                       class="flex items-center px-2 py-1.5 text-sm font-medium rounded-lg transition-colors
                              {{ request()->routeIs('payment-transactions.cash-process') ? 'bg-indigo-600 text-white' : 'text-gray-300 hover:bg-slate-700 hover:text-white' }}">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('reports.index') }}" 
                       class="flex items-center px-2 py-1.5 text-sm font-medium rounded-lg transition-colors
                              {{ request()->routeIs('reports.*') ? 'bg-indigo-600 text-white' : 'text-gray-300 hover:bg-slate-700 hover:text-white' }}">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
