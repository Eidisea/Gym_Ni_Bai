...
class TrainerProfileController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('management.trainer-profiles.index')
    ...
    public function show(TrainerProfile $trainerProfile)
    {
        ...
        $trainerProfile = TrainerProfile::withTrashed()->findOrFail($trainerProfile->trainer_id);
    ...
    public function update(Request $request, TrainerProfile $trainerProfile)
    {
        ...
        return redirect()->route('management.trainer-profiles.show', $trainerProfile)
