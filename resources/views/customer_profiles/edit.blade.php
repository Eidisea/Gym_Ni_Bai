    ...
    <ol class="inline-flex items-center space-x-1">
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('management.customer-profiles.show', $customerProfile) }}" class="text-gray-400 hover:text-gray-100 text-sm transition-colors">
...
<div class="bg-slate-800 border border-slate-700 rounded-lg p-4">
    <form method="POST" action="{{ route('management.customer-profiles.update', $customerProfile) }}">
        @csrf
        @method('PUT')
        ...
        <div class="flex items-center justify-end space-x-3 mt-6 pt-4 border-t border-slate-600">
            <a href="{{ route('management.customer-profiles.show', $customerProfile) }}" 
